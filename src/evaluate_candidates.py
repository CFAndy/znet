...
annotations = ca.load_candidates("../csv/annotations.csv")
found_candidates = []
...
def evaluate(train_candidates):
    ...
    # print "Before: ", nr_annotations, nr_candidates
    ...
    # print "After: ", nr_annotations, nr_candidates
